          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('표시 언어 설정 (Language)', style: TextStyle(color: Colors.white)),
                subtitle: Text(
              ...
              const ListTile(
                ...
                title: Text('AI 온디바이스 엔진', style: TextStyle(color: Colors.white)),
                subtitle: Text('Google ML Kit Pose Detection v3.0 (정밀 스캔 지원)', style: TextStyle(color: AppTheme.muted, fontSize: 12)),
              ),
              const SizedBox(height: 12),
              const ListTile(
                contentPadding: EdgeInsets.zero,
                leading: Icon(Icons.document_scanner_outlined, color: AppTheme.mint),
                title: Text('스크린 골프 OCR 인식 엔진', style: TextStyle(color: Colors.white)),
                subtitle: Text('골프존 / 카카오 / SG골프 모니터 레이아웃 지원', style: TextStyle(color: AppTheme.muted, fontSize: 12)),
              ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text('영상 촬영  /  구간·관절 지정  /  스크린 샷 OCR 연동', style: TextStyle(color: AppTheme.muted, fontSize: 12)),
          const SizedBox(height: 32),
          Row(
            children: [
